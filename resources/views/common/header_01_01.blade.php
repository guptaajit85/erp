          ...
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Daily Entry<span class="caret"></span></a>
            <ul class="dropdown-menu">
              ...
              <li class="dropdown-submenu"> <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Sale </a>
                <ul class="dropdown-menu">
                <?php if(!empty($addsaleentry)) { ?>  <li><a href="{{ route('add-saleentry') }}">Add Sale Entry</a></li> <?php } ?>
                <?php if(!empty($addsaleorder)) { ?>  <li><a href="{{ route('add-saleorder') }}">Add Sale Order</a></li> <?php } ?>
                </ul>
              </li>
              ...
              <li class="dropdown-submenu"> <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Purchase </a>
                <ul class="dropdown-menu">
                <?php if(!empty($addpurchase)) { ?>  <li><a href="{{ route('add-purchase') }}">Add Purchase Entry</a></li> <?php } ?>
                <?php if(!empty($addpurchaseorder)) { ?>   <li><a href="{{ route('add-purchaseorder') }}">Add Purchase Order</a></li>  <?php } ?>
                </ul>
              </li>
				...
				<li class="dropdown-submenu"> <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Work Order </a>
					<ul class="dropdown-menu">
						<?php if(!empty($showSaleorderitems)) { ?>	 <li><a href="{{ route('show-saleorderitems') }}">Create Work Order</a></li> <?php } ?>
						<?php if(!empty($showWorkorders)) { ?>  <li><a href="{{ route('show-workorders') }}">Work Order Process</a></li> <?php } ?>             
					</ul>
				</li>
              ...
              <li class="dropdown-submenu"> <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Warehouse Stock </a>
                <ul class="dropdown-menu"> 
					<?php if(!empty($addItemInWarehouse))  { ?>  <li><a href="{{ route('add-item-in-warehouse') }}">Add Item in Warehouse</a></li> <?php } ?>
					<?php if(!empty($showPurchaseRequest)) { ?>  <li><a href="{{ route('add-purchase-request') }}">Add Purchase Request</a></li> <?php } ?>
					<?php if(!empty($showWaeItemReirment)) { ?>  <li><a href="{{ route('show-warehouse-item-requirement') }}">Warehouse Requirement</a></li> <?php } ?>
					<?php if(!empty($showWorkOrderReport)) { ?>  <li><a href="{{ route('show-workorder-report') }}">Stock In Ward</a></li> <?php } ?>
                </ul>
              </li>
              ...
              <li class="dropdown-submenu"> <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Packaging </a>
                <ul class="dropdown-menu"> 
                <?php if(!empty($addPackaging)) { ?>  <li><a href="{{ route('add-packaging') }}">Add Package</a></li>  <?php } ?>               
				<?php if(!empty($addPackaging)) { ?>  <li><a href="{{ route('show-packagings') }}">Packaging List</a></li>  <?php } ?>      
                </ul>
              </li>
          ...
          <li class="dropdown"> 
            ...
            <ul class="dropdown-menu">
			  ...
			  <li class="dropdown-submenu"><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Warehouses </a>
				...
				<?php 				
					$checkBanks = CommonController::checkPagePermission('show-banks');			
				?>
