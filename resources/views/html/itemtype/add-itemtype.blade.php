        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
              <form class="col-sm-6" role="form" name="domainEdit" id="domainEdit" method="post" action="{{ url('store_itemtype') }}">
                @csrf
                <div class="form-group">
                  <label> Item Type   <span style="color:#ff0000;">*</span></label>
                  <input type="text" class="form-control" name="item_type_name" id="item_type_name" placeholder="Enter Item Type Name" required>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <select class="form-control" name="unit_type_id" id="unit_type_id">
                                       ...
                                       @foreach ($unitTypeData as $data)

                    <option value="{{ $data->unit_type_id }}">{{ $data->unit_type_name }}</option>
                ...
                <div class="reset-button">
                  <input type="submit" name="submit" value="Save" class="btn btn-success" id="save">
                  <input type="reset" name="Reset" value="Reset" class="btn btn-warning"> </div>
              </form>
            </div>
          </div>
        </div>
