  ...
  <div class="content-wrapperd">
    ...
    <section class="content-header">
      ...
      <div class="header-title">
        <h1>Update Quality Type</h1>
        <small>Quality Type List</small> </div>
    </section>
    <!-- Main content -->
		...
		{!! CommonController::display_message('message') !!}
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-qualitytypes') }}"> <i class="fa fa-list"></i> Quality Type List </a> </div>
            </div>
            <div class="panel-body">
              <form class="col-sm-6" role="form" name="domainEdit" id="domainEdit" method="post"
                                    action="{{ url('/update_qualitytype') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  <label> Quality Type Name   <span style="color:#ff0000;">*</span></label>
                  <input type="text" class="form-control" name="qualitytype_name" id="qualitytype_name"
                                            value="{{ htmlentities($data->qualitytype_name) }}" placeholder="Enter Quality Type Name"
                                            required>
