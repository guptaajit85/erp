               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
						...
						<form action="{{ route('show-cities') }}" method="GET" role="search">	  
						  @csrf 
						 ...
						 <div class="col-sm-2 col-xs-12">
                            <a class="btn btn-add" href="add-city"> <i class="fa fa-plus"></i> Add City </a>  
                          </div>
                        </div>
                                 ...
                                 <tbody>
								  ...
								  @foreach($dataQ as $data)
									<tr id="Mid{{ $data->id }}">
										...
										<td><a href="edit-city/{{ base64_encode($data->id) }}" class="tooltip-info"><i class="fa fa-pencil"></i></a></td>			
										<td class="center"><a href="javascript:void(0);" onclick="deleteCity({{ $data->id }})" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a> </td>		 
									</tr>
								  @endforeach
...
var siteUrl = "{{url('/')}}";
	...
	{	
		if(confirm("Do you realy want to delete this record?"))
		{
			jQuery.ajax({
				type: "GET", 
				url: siteUrl + '/' +"ajax_script/deleteCity",
				data: {
					"_token": "{{ csrf_token() }}",
					"FId":id,	 			
				},	 	
