              ...
              <div class="row" style="margin-bottom:5px">
                <form action="{{ route('show-warehouses') }}" method="GET" role="search">
                  ...
                  <div class="col-sm-4 col-xs-12">
                    <input type="text" class="form-control" name="qsearch" id="qsearch" value="" placeholder="Search by Item Name">
                  </div>
              ...
              <div class="table-responsive">
                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                  ...
                  <tr class="center text-center">
                    <td class="center" colspan="10"><div class="pagination">{{ $dataWPR->links() }}</div></td>
                  </tr>
                  </tbody>
