          ...
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonexport"><a href="javascript:void(0);">
                <h4>Start Requisition For Dyeing Process</h4>
                </a></div>
            </div>
                    ...
                    <td> 					
						  <table class="table table-bordered">
							<tbody>							
								...
								<?php foreach($data['WorkOrderItem'] as $rowArr) 
									{  
			   ...
			   <table class="table table-bordered" id="myTable">
                <tbody>
                  <tr>
                    ...
                    <th><span id="ReqProduct"></span>Color Item </th>
                    <th>Quantity</th>
                    <th>Unit</th>
                  </tr>
                  <tr>
...
<script>
	function addRow() 
	{
		...
		cell1.innerHTML = '<select  class="form-control" name="req_item_id[]"><option value=""> Select Item</option><?php foreach($dataIC as $rowArr) { ?><option value="<?=$rowArr->item_id;?>"><?=$rowArr->item_name;?></option><?php } ?></select> ';
