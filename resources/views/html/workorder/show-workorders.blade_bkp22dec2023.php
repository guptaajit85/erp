        ...
        <div class="col-sm-12"> {!! CommonController::display_message('message') !!}
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonexport"><a href="javascript:void(0);"><h4>Work Order List</h4></a></div>
            </div>
...
{	
	...
	$('#CoatingInspProcessPop').modal({backdrop: 'static', keyboard: false});		 
}
</script> 
...
{	
	...
	$('#DyeingInspProcessPop').modal({backdrop: 'static', keyboard: false});		 
}
</script>
...
{	
	...
	$('#WeavingInspProcessPop').modal({backdrop: 'static', keyboard: false});		 
}
</script>
