                        ...
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" style="margin-bottom:5px">
                                    <form action="{{ route('show-accountgroups') }}" method="GET" role="search">
                                      @csrf
                                     ...
                                     <div class="col-sm-2 col-xs-12">
                                        <a class="btn btn-add" href="add-accountgroup"> <i class="fa fa-plus"></i> Add
                                            Account Group
                                        </a>
                                      </div>
                                    </div>
	 ...
	 var siteUrl = "{{url('/')}}";
        function deleteAccountGroup(id) 
		{
            if (confirm("Do you realy want to delete this record?")) {
                jQuery.ajax({
                    type: "GET",
                    url: siteUrl + '/' +"ajax_script/deleteAccountGroup",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "FId": id,
                    },
