        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-coatedfabrics') }}"> <i class="fa fa-list"></i> Coated Febric List </a> </div>
            </div>
