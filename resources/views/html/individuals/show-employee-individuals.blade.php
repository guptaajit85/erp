          ...
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonexport"> <a href="javascript:void(0);">
                <h4>Employee Individual List</h4>
                </a> </div>
            </div>
            <div class="panel-body">
              <div class="row" style="margin-bottom:5px">
                <form action="{{ route('show-employee-individuals') }}" method="GET" role="search">
                  @csrf
                ...
                <div class="col-sm-2 col-xs-12"> <a class="btn btn-add" href="add-employee-individual"> <i class="fa fa-plus"></i> Add Employee Individual </a> </div>
              </div>
