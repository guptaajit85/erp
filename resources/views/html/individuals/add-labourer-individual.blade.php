 ...
 <div class="content-wrapperd">
    ...
    <section class="content-header">
      ...
      <div class="header-title">
        <h1>Add Labourer Individual</h1>
        <small>Labourer Individual list</small> </div>
    </section>
    <!-- Main content -->
        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-labourer-individuals') }}"> <i class="fa fa-list"></i> Labourer Individual List </a> </div>
            </div>
            <div class="panel-body">
              <form  role="form" name="indvEdit" id="indvEdit" method="post" onSubmit="return validateForm()" action="{{ url('store_labourer_individual') }}">
                @csrf
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="type" id="type" value="labourer" >
                      </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
