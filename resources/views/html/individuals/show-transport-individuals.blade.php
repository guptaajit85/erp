        ...
        <div class="panel panel-bd lobidrag">
          <div class="panel-heading">
            <div class="btn-group" id="buttonexport"> <a href="javascript:void(0);">
              <h4>Transport Individual List</h4>
              </a> </div>
          </div>
          <div class="panel-body">
            <div class="row" style="margin-bottom:5px">
              <form action="{{ route('show-transport-individuals') }}" method="GET" role="search">
                @csrf
              ...
              <div class="col-sm-2 col-xs-12"> <a class="btn btn-add" href="add-transport-individual"> <i class="fa fa-plus"></i> Add Transport Individual </a> </div>
            </div>
            ...
            <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
              ...
              <tr id="Mid{{ $data->id }}">
                ...
                <td><a class="btn btn-add" href="show-transports/{{ $id }}"> View Transport Details </a> </td>
              </tr>
              @endforeach
              <tr class="center text-center">
                <td class="center" colspan="13><div class="pagination"> {{ $dataI->links('vendor.pagination.bootstrap-4')}}
              </div>
              </td>
