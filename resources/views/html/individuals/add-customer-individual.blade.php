 ...
 <div class="content-wrapperd">
    ...
    <section class="content-header">
      ...
      <div class="header-title">
        <h1>Add Customers Individual</h1>
        <small>Customers Individual list</small> </div>
    </section>
    <!-- Main content -->
        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-customers-individuals') }}"> <i class="fa fa-list"></i> Customers Individual List </a> </div>
            </div>
            <div class="panel-body">
              <form  role="form" name="indvEdit" id="indvEdit" method="post" onSubmit="return validateForm()" action="{{ url('store_customer_individual') }}">
                @csrf
                ...
                <div class="col-sm-6">
                    ...
                    <input type="hidden" class="form-control" name="type" id="type" value="customers">
                  </div></div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" oninput="limitInputLength(this, 10)" name="phone" maxlength="10" id="phone" placeholder="Enter Mobile" >
                  </div>
                </div>
...
$().ready(function() {
	$("#indvEdit").validate({
		...
		messages: {
			...
			email:
			{
				required: "<span class='required'>Please enter your email Id.</span>"
			},
			phone:
			{
				required: "<span class='required'>Please enter your mobile number.</span>",
				min:"<span class='required'>Please enter your valid mobile number.</span>"
			},
