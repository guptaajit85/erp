          ...
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonexport"> <a href="javascript:void(0);">
                <h4>Customers Individual List</h4>
                </a> </div>
            </div>
            <div class="panel-body">
              <div class="row" style="margin-bottom:5px">
                <form action="{{ route('show-customers-individuals') }}" method="GET" role="search">
                  @csrf
                ...
                <div class="col-sm-2 col-xs-12"> <a class="btn btn-add" href="add-customer-individual"> <i class="fa fa-plus"></i> Add Customer Individual </a> </div>
              </div>
              ...
              <div class="table-responsive">
                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                  ...
                  <tr id="Mid{{ $data->id }}">
                    ...
                    <td><a class="btn btn-add" href="show-customers/{{ $id }}"> View Customers Details </a> </td>
                  </tr>
                  @endforeach
