          ...
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonexport"> <a href="javascript:void(0);">
                <h4>Labourer Individual List</h4>
                </a> </div>
            </div>
            <div class="panel-body">
              <div class="row" style="margin-bottom:5px">
                <form action="{{ route('show-labourer-individuals') }}" method="GET" role="search">
                  @csrf
                ...
                <div class="col-sm-2 col-xs-12"> <a class="btn btn-add" href="add-labourer-individual"> <i class="fa fa-plus"></i> Add Labourer Individual </a> </div>
              </div>
              ...
              <div class="table-responsive">
                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                  ...
                  <tr id="Mid{{ $data->id }}">
                    ...
                    <td><a class="btn btn-add" href="show-labourers/{{ $id }}"> View Labourers Details </a> </td>
                  </tr>
                  @endforeach
                  <tr class="center text-center">
                    <td class="center" colspan="13"><div class="pagination">@if(empty($dataI->count()))  Record Not  Found.  @endif  {{ $dataI->links('vendor.pagination.bootstrap-4')}} </div></td>
                  </tr>
                  </tbody>
