 ...
 <div class="content-wrapperd">
    ...
    <section class="content-header">
      ...
      <div class="header-title">
        <h1>Add Agent Individual</h1>
        <small>Agent Individual list</small> </div>
    </section>
    <!-- Main content -->
        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-agents-individuals') }}"> <i class="fa fa-list"></i> Agent Individual List </a> </div>
            </div>
            <div class="panel-body">
              <form role="form" name="indvEdit" id="indvEdit" method="post" onSubmit="return validateForm()" action="{{ url('store_agent_individual') }}">
                @csrf
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="type" id="type" value="agents" >
                      </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
...
$().ready(function() {
	$("#indvEdit").validate({
		...
		messages: {
			...
			adhar:
			{
				required: "<span class='required'>Please enter your Adhaar number.</span>",
				min:"<span class='required'>Please enter your valid Adhaar number.</span>"
			},
			whatsapp:
			{
