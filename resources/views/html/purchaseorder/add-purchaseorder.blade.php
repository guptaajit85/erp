		...
		{!! CommonController::display_message('message') !!}
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add" href="{{ route('show-purchaseorders')}}"> <i class="fa fa-list"></i> New Purchase Order </a> </div>
            </div>
            <div class="panel-body">
              <form method="post" action="{{ route('store_purchaseorder')}}" onSubmit="return check_form();" autocomplete="off">
                @csrf
                <div class="row">
                    ...
                    <table class="table table-bordered">
                      <tbody>
                        <tr>
                          ...
                          <td style="width:150px;"><label for="purchase_number">P.O. Number  <span style="color:#ff0000;">*</span></label>
                            <input type="text" id="purchase_number" required class="form-control" name="purchase_number">
                          </td>
                          <td style="width:200px;"><label for="purchase_started">Purchase Order Date  <span style="color:#ff0000;">*</span></label>
                            <input type="text" id="purchase_started" required class="form-control" name="purchase_started">
                          </td>
                  ...
                  <div class="col-md-12" id="main_div" style="display:nonee">
                          ...
                          <table class="table table-bordered">
                            <tbody>
                              <tr>
								...
								<td style="width:150px;"><label for="pur_type">Type   <span style="color:#ff0000;">*</span></label>
								...
								<td><p>Product   <span style="color:#ff0000;">*</span></p>
                                ...
                                <td style="width:80px;">
								   <div class="input-group">
                                    <p>Unit</p>
                                    <select id="unit" name="unit" onChange="changeUnit();" class="form-control">
								...
								<td style="width:6%" id="meterId">								
								  <div class="input-group">
                                    <p>Meter</p>
                                    <input type="text" id="meter" name="meter" class="form-control" value="1">
                                  </div>								  
								</td>
                                ...
                                <td style="width:80px;display:none;" ><div class="input-group">
                                    <p>CESS</p>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          <thead>
                            <tr>
                              ...
                              <th style="width:8%;" class="mrplabel">MRP</th>
                              ...
                              <th style="width:8%; display:none;">CESS</th>
...
<script>
  $('#Add_To_Purchase').click(function(){
		if($('#product_name').val() != '' )
		{
			...
			// "<td>"+count_product+"</td>"+
			"<td><input value='"+$('#pro_id').val()+"' type='hidden' name='pro_id_arr[]' readonly><input value='"+$('#dis_type').val()+"' type='hidden' name='dis_type_arr[]' readonly><input readonly value='"+$('#pur_type').val()+"' type='text' class='form-control' name='pur_type_arr[]'> </td>"+
			
			
			"<td><input readonly value='"+$('#product_name').val()+"' type='text' class='form-control' name='product_name_arr[]'></td>"+
