          ...
          <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
              <div class="row" style="margin-bottom:5px">
                <form action="{{ route('show-purchaseorders') }}" method="GET" role="search">
                  @csrf
                ...
                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                  <thead>
                    <tr class="info">
                      ...
                      <th>Vendor Name </th>   
                      <th>Item Type </th>                    
                      <th>Purchased Order Placed On </th> 
                      <th>Total Item </th>
                      <th>Total</th>
                      <th>Action</th>
                      <th>Delete </th>
				  ...
				  <?php 
				    $purchaseId = $data->id;
					$purArr =  CommonController::getPurchaseOrderItemTypeArr($purchaseId);
					$count  =  CommonController::getPurchaseOrderItemTypeCount($purchaseId);
                  ...
                  <tr id="Mid{{ $data->id }}">
                    ...
                    <td> {{ $data->total }} </td>
                    <td><a target="_blank" href="print-purchaseorder/{{ base64_encode($data->id) }}" class="tooltip-info">
