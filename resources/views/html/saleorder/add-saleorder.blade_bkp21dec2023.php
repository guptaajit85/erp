                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width:150px;"><label for="sale_order_number">Order Type</label>
                            <select class="form-control" name="sale_order_type" required id="sale_order_type">
                          ...
                          <td style="width:150px;"><label for="sale_order_number">Sale Order Number</label>
                            <input type="text" id="sale_order_number" required class="form-control" name="sale_order_number">
                          </td>
                          <td style="width:150px;"><label for="sale_order_date">Sale Order Date</label>
                            <input type="text" id="sale_order_date" required class="form-control" data-date-format="dd-mm-yyyy" name="sale_order_date" onblur="changedeliveryDate();">
                          </td>
                          <td style="width:150px;"><label for="">Sales Order</label>
                            <select id="sales_order" name="sales_order" onChange="changeSaleOrder();" class="form-control" required>
                          ...
                          <td style="width:150px;" >
							...
							<input type="text" class="form-control" name="sale_order_from" id="sale_order_from">
							</span>
                          </td>
                        </tr>
                        <tr>
                          <td style="width:150px;"><label for="Order By Employee">Order By Employee</label>
                            <select class="form-control" name="ind_employee_id" required id="ind_employee_id">
                          ...
                          <td style="width:150px;"><label for="order_priority">Sale Order Priority</label>
                            <select id="order_priority" name="order_priority" onChange="orderPriority();" class="form-control" required>
                          ...
                          <td style="width:150px;"><div class="hidden">
                          ...
                          <td><label for="exampleInputCategory1">Billing Address </label>
							<br />
							<p><a class="btn btn-primary btn-sm pull-left" target="_blank" href="{{ route('add-individualaddress')}}">Add Billing & Shipping Address</a></p>
							<br />
							<p>
						  ...
						  <table class="table table-bordered">
								<tbody>
								 <tr>
								  ...
								  <tr>
									<td><input type="text" id="product_name" name="product_name" class="form-control" placeholder="Name"></td>
...
function check_form()
{
  ...
  $( function() {
	...
	$("#sale_order_date,#expect_delivery_date").datepicker(
	{
		dateFormat: "dd-mm-yy",
		 minDate: -15,
        maxDate: 15,
