  ...
  <div class="content-wrapperd">
    ...
    <section class="content-header">
      ...
      <div class="header-title">
        ...
        <small> Department list</small> </div>
    </section>
    <!-- Main content -->
        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-departments') }}"> <i class="fa fa-list"></i> Department List </a> </div>
            </div>
            <div class="panel-body">
              <form class="col-sm-6" role="form" name="domainEdit" id="domainEdit" method="post" action="{{ url('store_department') }}">
                @csrf
...
<script language="javascript" type="text/javascript">
        $().ready(function() {
            $("#domainEdit").validate({
                ...
                messages: {
                    name: {
                        required: "<span style='color: red;'>Please enter a Department Name</span>",
