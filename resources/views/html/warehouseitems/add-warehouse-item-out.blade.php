		...
		{!! CommonController::display_message('message') !!}
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="javascript:void|(0);"> <i class="fa fa-list"></i> Warehouse Items Out</a> </div>
            </div>
            <div class="panel-body">
              <form method="post" action="{{ route('store_item_out')}}" onSubmit="return check_form();" autocomplete="off">
                @csrf
                <div class="row">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td><label for="emp_name">Receiver Employee Name</label>
                          <input type="text" id="emp_name" class="form-control" name="emp_name" value="">
                        ...
                        <td><label>Reciving Date</label>
                          <input type="text" id="receiving_date"  class="form-control" data-date-format="yyyy-mm-dd" name="receiving_date" class="form-control" readonly>
                        </td>
                        <!--- <td><label for="receiver_name">Receiver Name</label>
						  ...
						  ------>
                        <td><label for="invoice_number">Invoice Number</label>
                          <input type="text" id="invoice_number"  class="form-control" name="invoice_number" class="form-control" >
                          <table class="table table-bordered">
                            <tbody>
