		...
		{!! CommonController::display_message('message') !!}
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-persons') }}"> <i class="fa fa-list"></i> Person List </a> </div>
            </div>
            <div class="panel-body">
              <form class="col-sm-6" files='true' name="productEdit" id="productEdit" method="post" action="{{ route('store_person')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="dob" id="dob" placeholder="Select dob" >
                </div>
                <div class="form-group">
                  <label>Date Of Anniversary</label>
                  <input type="text" class="form-control" name="doa" id="doa" placeholder="Select doa" >
                </div>
                <div class="form-group">
                  <label>Image</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="fb_link" id="fb_link" placeholder="Select fb_link" >
                </div>
                <div class="form-group">
                  <label>Call Number</label>
                  <input type="text" class="form-control" name="call_no" id="call_no" placeholder="Select call_no" >
                </div>
                <div class="form-group">
