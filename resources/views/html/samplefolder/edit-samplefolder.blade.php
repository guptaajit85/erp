  ...
  <div class="content-wrapperd">
    ...
    <section class="content-header">
      ...
      <div class="header-title">
        <h1>Update Sample Folder</h1>
        <small>Sample Folder list</small> </div>
    </section>
    <!-- Main content -->
        ...
        <div class="col-sm-12">{!! CommonController::display_message('message') !!}
          <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
              <div class="btn-group" id="buttonlist"> <a class="btn btn-add " href="{{ route('show-samplefolders') }}"> <i class="fa fa-list"></i> Sample Folders List </a> </div>
            </div>
            <div class="panel-body">
              <form class="col-sm-6" role="form" name="domainEdit" id="domainEdit" method="post" action="{{ url('/update_samplefolder') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  <label> Sample Folder Name  <span style="color:#ff0000;">*</span></label>
                  <input type="text" class="form-control" name="name" id="name" value="{{ htmlentities($data->name) }}" placeholder="Enter Sample Folder Name" required>
