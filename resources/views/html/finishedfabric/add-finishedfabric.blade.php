        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
              <form class="col-sm-6" files='true' name="productEdit" id="productEdit" method="post" action="{{ route('store_finishedfabric')}}" enctype="multipart/form-data">
                @csrf
