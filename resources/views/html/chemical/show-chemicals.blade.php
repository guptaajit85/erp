                            ...
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" style="margin-bottom:5px">
                                        <form action="{{ route('show-chemicals') }}" method="GET" role="search">
                                          @csrf
                                         ...
                                         <div class="col-sm-2 col-xs-12">
                                            <a class="btn btn-add" href="add-chemical"> <i class="fa fa-plus"></i> Add
                                                Chemical
                                            </a>
                                          </div>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($dataP as $data)
                                                    <tr id="Mid{{ $data->id }}">
                                                        ...
                                                        <td><a href="edit-chemical/{{ base64_encode($data->id) }}"
                                                                class="tooltip-info"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td class="center"><a href="javascript:void(0);"
                                                                onclick="deleteChemical({{ $data->id }})"
	...
	var siteUrl = "{{url('/')}}";
        function deleteChemical(id) {
            if (confirm("Do you realy want to delete this record?")) {
                jQuery.ajax({
                    type: "GET",
                    url: siteUrl + '/' +"ajax_script/deleteChemical",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "FId": id,
                    },
