                        ...
                        <div class="panel panel-bd lobidrag">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="col-sm-6" role="form" name="domainEdit" id="domainEdit" method="post"
                                    action="{{ url('/update_chemical') }}" enctype="multipart/form-data">

                                    @csrf

                                    <div class="form-group">
                                        <label> Chemical Name   <span style="color:#ff0000;">*</span></label>
                                        <input type="text" class="form-control" name="chemical_name"
                                            id="chemical_name" value="{{ htmlentities($data->chemical_name) }}"
                                            placeholder="Enter Chemical Name" required>
