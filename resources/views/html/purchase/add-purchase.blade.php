                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <table class="table table-bordered">
                      <tbody>
                        <tr>                          
                          <td style="width:150px;"><label for="purchase_order_number">P. O. Number </label>
                            <input type="text" id="purchase_order_number"  class="form-control" name="purchase_order_number" class="form-control" value="" >
                          </td>
                          ...
                          <td style="width:260px;"><div class="hidden">
							...
							<!--- </br><td><label for="exampleInputCategory1">Shiping Address </label><p><span id="Shipaddress"></span></p></td> --->
  ...
  $('#Add_To_Purchase').click(function()
		{
			if($('#product_name').val() != '' )
			{
				...
				if( $('#final_price').val() !=0)
				{
					...
					"<th><input readonly value='"+$('#pur_type').val()+"' type='text' class='form-control' name='pur_type_arr[]'></th>"+
