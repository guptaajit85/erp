 ...
 <div class="content-wrapperd">
    <section class="content">
        ...
        <div class="col-sm-12"> 
          <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
			 ...
			 <div class="col-sm-12 phead"><h2>PURCHASE ORDER</h2></div>
	 ...
	 ?>
				  ...
				  <tr>
					  <td colspan="7">Amount Chargeable (in word) <br> 
...
<div class="float-end" style="float:right;margin-right:125px;">
<a href="javascript:window.print()" class="btn btn-success me-1m printbtn"><i class="fa fa-print"></i></a>
</div>
