              ...
              <div class="table-responsive">
                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                  ...
                  <tr id="Mid{{ $data->sale_entry_id}}">
                    ...
                    <!-- <td> {!! CommonController::getItemType($data->
                    sale_entry_type_id) !!}
                    </td>
                    -->
                    <td> {{ date('F jS, Y',strtotime($data->sale_entry_on)) }} </td>
                    <td> {{ $data->total}} </td>
                    <td><a href="{{ route('print-saleentry', base64_encode($data->sale_entry_id)) }}" title="Print" class="tooltip-info">
