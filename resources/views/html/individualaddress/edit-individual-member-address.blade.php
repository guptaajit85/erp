        ...
        <div class="col-sm-12">
          <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
              <form class="col-sm-6" name="domainEdit" id="domainEdit" method="post" action="{{ url('/update_individual_member_address') }}">
                @csrf
                <div class="form-group"> 
                    ...
                    <input type="hidden" class="form-control" name="ind_add_id" id="ind_add_id" value="{{ htmlentities($data->ind_add_id) }}">
                </div>
                <div class="form-group">
