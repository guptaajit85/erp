...
class VendorController extends Controller
{
    ...
    { 
		...
		$dataP = Vendor::where('status', '=', '1')->paginate(20); 
		// echo "<pre>";  print_r($dataI); exit; 
		return view('html.vendor.show-vendors',compact("dataP","qsearch","dataI"));  
    }
    ...
    public function edit_vendor ($id)
	{
        ...
        $dataI = Individual::where('id', $indID)->first(); 	        
		return view('html.vendor.edit-vendor',compact("data","dataI"));
	}
    ...
    public function create_vendor($id)
    {
		...
		return view('html.vendor.add-vendor',compact("data","indID"));
    }
	...
	public function store_vendor(Request $request )
    {
	  ...
	  // echo "<pre>"; print_r($request->all()); exit;
		...
		$obj->vendor_from  		    = $request->vendor_from;
		$obj->vendor_to  		    = $request->vendor_to;
		...
		if($is_saved)
		{
            ...
            return redirect("/show-vendors/".base64_encode($obj->individual_id));
		}
	...
	//  echo "<pre>"; print_r($request->all()); exit;
		...
		$obj = Vendor::where('id','=', $request->id)->first();
	...
	//	$obj->name  				= $request->name;
		...
		if($is_saved)
		{
			...
			Session::put("messageClass","successClass");
			return redirect("/show-vendors/".base64_encode($request->individual_id));
		}
